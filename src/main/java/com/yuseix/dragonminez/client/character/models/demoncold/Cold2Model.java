...
public class Cold2Model<T extends LivingEntity> extends PlayerModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(DragonMineZ.MOD_ID, "races"), "cd_second");
	...
	public Cold2Model(ModelPart root) {
		super(root, false);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cuernos = head.addOrReplaceChild("cuernos", CubeListBuilder.create(), PartPose.offset(0.0F, -0.05F, 0.0F));

		PartDefinition cube_r1 = cuernos.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(55, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-6.6F, -10.6F, 0.0F, 0.0F, 0.0F, 0.2618F));

		PartDefinition cube_r2 = cuernos.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(55, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-6.0F, -8.85F, 0.0F, 0.0F, 0.0F, -0.48F));

		PartDefinition cube_r3 = cuernos.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(55, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.25F, -7.5F, 0.0F, 0.0F, 0.0F, -1.0908F));

		PartDefinition cuernos2 = head.addOrReplaceChild("cuernos2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r4 = cuernos2.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(55, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-6.6F, -10.6F, 0.0F, 0.0F, 0.0F, 0.2618F));

		PartDefinition cube_r5 = cuernos2.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(55, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-6.0F, -8.85F, 0.0F, 0.0F, 0.0F, -0.48F));

		PartDefinition cube_r6 = cuernos2.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(55, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.25F, -7.5F, 0.0F, 0.0F, 0.0F, -1.0908F));
