...
import com.yuseix.dragonminez.common.init.menus.screens.GuruMenu;
...
public class GuruEntity extends MastersEntity implements GeoEntity {
	...
	private <T extends GeoAnimatable> PlayState predicate(AnimationState<T> tAnimationState) {
		if (tAnimationState.isMoving()) {
			tAnimationState.getController().setAnimation(RawAnimation.begin().then("animation.guru.idle", Animation.LoopType.LOOP));
		} else {
			tAnimationState.getController().setAnimation(RawAnimation.begin().then("animation.guru.idle", Animation.LoopType.LOOP));
		}
