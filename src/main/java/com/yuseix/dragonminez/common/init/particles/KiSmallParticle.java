...
public class KiSmallParticle extends TextureSheetParticle {

	private final SpriteSet sprites; // Variable para almacenar el SpriteSet

	protected KiSmallParticle(ClientLevel level, double x, double y, double z, SpriteSet texture, double xSpeed, double ySpeed, double zSpeed, int color) {
		...
		this.friction = 0.9F; // Qué tan lejos va
	...
	public static class Provider implements ParticleProvider<KiSmallParticleOptions> {
		...
		@Override
		public Particle createParticle(KiSmallParticleOptions type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			return new KiSmallParticle(level, x, y, z, this.sprites, xSpeed, ySpeed, zSpeed, type.getColor());
		}
	}
}