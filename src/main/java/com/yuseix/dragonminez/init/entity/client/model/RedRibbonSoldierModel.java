...
public class RedRibbonSoldierModel<T extends LivingEntity> extends PlayerModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(DragonMineZ.MOD_ID, "redribbon"), "soldier01");
	...
	public RedRibbonSoldierModel(ModelPart root) {
        super(root, false);
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(32, 32).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 3.0F, 8.0F, new CubeDeformation(0.3F))
		.texOffs(46, 43).addBox(-4.0F, -5.0F, -6.25F, 8.0F, 0.0F, 2.0F, new CubeDeformation(0.2F))
		.texOffs(32, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.2F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		.texOffs(48, 48).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.2F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
