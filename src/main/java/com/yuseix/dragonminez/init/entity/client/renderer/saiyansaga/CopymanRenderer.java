...
public class CopymanRenderer extends LivingEntityRenderer<SaibamanEntity, PlayerModel<SaibamanEntity>> {
    public CopymanRenderer(EntityRendererProvider.Context pContext) {
    ...
    public ResourceLocation getTextureLocation(SaibamanEntity saibamanEntity) {
        return new ResourceLocation(DragonMineZ.MOD_ID,"textures/entity/sagas/saiyan/saibaman_3.png");
    }
