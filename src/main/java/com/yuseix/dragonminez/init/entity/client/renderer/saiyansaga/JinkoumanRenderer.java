...
public class JinkoumanRenderer extends LivingEntityRenderer<SaibamanEntity, PlayerModel<SaibamanEntity>> {
    public JinkoumanRenderer(EntityRendererProvider.Context pContext) {
    ...
    public ResourceLocation getTextureLocation(SaibamanEntity saibamanEntity) {
        return new ResourceLocation(DragonMineZ.MOD_ID,"textures/entity/sagas/saiyan/saibaman_5.png");
    }
