...
public class KaiwaremanRenderer extends LivingEntityRenderer<SaibamanEntity, PlayerModel<SaibamanEntity>> {
    public KaiwaremanRenderer(EntityRendererProvider.Context pContext) {
    ...
    public ResourceLocation getTextureLocation(SaibamanEntity saibamanEntity) {
        return new ResourceLocation(DragonMineZ.MOD_ID,"textures/entity/sagas/saiyan/saibaman_1.png");
    }
