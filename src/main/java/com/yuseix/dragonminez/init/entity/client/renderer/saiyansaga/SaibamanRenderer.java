...
public class SaibamanRenderer extends LivingEntityRenderer<SaibamanEntity, PlayerModel<SaibamanEntity>> {
    public SaibamanRenderer(EntityRendererProvider.Context pContext) {
